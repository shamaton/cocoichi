...
struct CurryBasicsContent: View {
...
struct CurryToppingSectionList: View {
    @EnvironmentObject private var orderStore: OrderStore
...
struct CurryDetailHeroMinYPreferenceKey: PreferenceKey {
...
enum RiceArtworkTransitionDirection {
    case increase
    case decrease
...
enum SpiceArtworkTransitionDirection {
    case increase
    case decrease
